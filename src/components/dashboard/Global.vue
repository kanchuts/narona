...
import {APIServiceGlobal} from '../../services/APIServiceGlobal';
        ...
        renderChartGlobal () {
            ...
            apiService.getGlobal()
                .then((data) => {
                    ...
                    dataPositif.push(day.TotalConfirmed)
                    dataSembuh.push(day.TotalRecovered)
                    dataMeninggal.push(day.TotalDeaths)
                    }
